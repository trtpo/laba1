...
public class ComplexTest {
    ...
    public void testPlus() {
        ...
        Assert.assertEquals(new Complex(3,6),result);
    }
   ...
   public void testTimes() {
        ...
        Assert.assertEquals(new Complex(-6,8),result);
    }
    ...
    public void testMinus() {
        ...
        Assert.assertEquals(new Complex(0,1),result);
    }
    ...
    public void testSin() {
        ...
        Assert.assertEquals(real, result.getRe(), 0);
        Assert.assertEquals(imag, result.getIm(), 0);
    }
