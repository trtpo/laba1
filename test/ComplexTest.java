...
class ComplexTest {
 ...
 public  ExpectedException thrown = ExpectedException.none();
    ...
    void divide() {
        ...
        assertTrue(numberToTest_1.clone().divide(numberToTest_2).equals(new Complex(-(double)5566/7265, (double)6022/7265)),
                "Test for simple division with the same signs.");
        ...
        assertTrue(numberToTest_3.clone().divide(numberToTest_1.clone()).equals(new Complex(-(double)343/2314,(double)1519/4628)),
                "Test for simple division with the different signs #2.");
